...
p, span, label, li { color: #E2D9CC !important; }
h1, h2, h3, h4, h5, h6 { color: #F0EAE0 !important; }
.stCaption p,
[data-testid="stCaptionContainer"] p { color: #6B6058 !important; font-size: 0.8rem !important; }
...
[data-testid="stExpander"] summary { color: #C8BFB0 !important; font-size: 0.88rem !important; }
[data-testid="stExpander"] summary:hover { color: #BFA14A !important; }

/* ── PROGRESS BAR ── */
[data-testid="stProgress"] > div > div { background: #BFA14A !important; }
[data-testid="stProgress"] > div { background: #1E1E1E !important; }
...
[data-testid="stSlider"] { color: #6B6058 !important; }
.stSlider [data-testid="stThumbValue"] { color: #BFA14A !important; }

/* ── CHECKBOXES ── */
[data-testid="stCheckbox"] label p { color: #6B6058 !important; font-size: 0.82rem !important; }
...
[data-testid="stInfo"] p { color: #B8A060 !important; }
...
.ms-footer a { color: #BFA14A !important; text-decoration: none; }
